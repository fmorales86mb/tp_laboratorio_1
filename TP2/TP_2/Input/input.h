/**
* \brief Solicita un número int al usuario y lo chequea
...
/**
* \brief Solicita un número float al usuario y lo chequea
...
/**
* \brief Solicita un número long int al usuario y lo chequea
* \param input Se carga el numero ingresado (es una dirección de memoria).
* \param message Es el mensaje a ser mostrado
* \param eMessage Es el mensaje a ser mostrado en caso de error
* \param lowLimit Limite inferior a validar
